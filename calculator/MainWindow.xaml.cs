...
namespace calculator
{
    public partial class MainWindow : Window
    {
        ...
        private void Button_Eq(object sender, RoutedEventArgs e)
        {
            ...
            switch (_operation)
            {
                case "+": { actionHandler = add; break; }
                case "-": { actionHandler = sub; break; }
                case "*": { actionHandler = mul; break; }
                case "/": { actionHandler = dev; break; }
                default: { ResetValues(); break; }
            }
            Result.Text = actionHandler(ref _lvalue, _rvalue);
        }
